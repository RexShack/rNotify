...
AddEventHandler('rNotify:NotifyLeft', function(firsttext, secondtext, dict, icon, duration)
    ...
    exports.rNotify:ShowAdvancedNotification(tostring(firsttext), tostring(secondtext), tostring(_dict), tostring(_icon), tonumber(duration))
end)

RegisterNetEvent('rNotify:Tip')
AddEventHandler('rNotify:Tip', function(text, duration)
    exports.rNotify:ShowTooltip(tostring(text), tonumber(duration))
end)

RegisterNetEvent('rNotify:NotifyTop')
AddEventHandler('rNotify:NotifyTop', function(text, location, duration)
    exports.rNotify:ShowLocationNotification(tostring(text), tostring(location), tonumber(duration))
end)

RegisterNetEvent('rNotify:ShowSimpleRightText')
AddEventHandler('rNotify:ShowSimpleRightText', function(text, duration)
    exports.rNotify:ShowSimpleRightText(tostring(text), tonumber(duration))
end)

RegisterNetEvent('rNotify:ShowObjective')
AddEventHandler('rNotify:ShowObjective', function(text, duration)
    exports.rNotify:ShowObjective(tostring(text), tonumber(duration))
end)

RegisterNetEvent('rNotify:ShowTopNotification')
AddEventHandler('rNotify:ShowTopNotification', function(tittle, subtitle, duration)
    exports.rNotify:ShowTopNotification(tostring(tittle), tostring(subtitle), tonumber(duration))
end)

RegisterNetEvent('rNotify:ShowAdvancedRightNotification')
AddEventHandler('rNotify:ShowAdvancedRightNotification', function(text, dict, icon, text_color, duration)
    local _dict = dict
    local _icon = icon
    if not LoadTexture(_dict) then
        _dict = "generic_textures"
    ...
    exports.rNotify:ShowAdvancedRightNotification(tostring(text), tostring(_dict), tostring(_icon), tostring(text_color), tonumber(duration))
end)

RegisterNetEvent('rNotify:ShowBasicTopNotification')
AddEventHandler('rNotify:ShowBasicTopNotification', function(text, duration)
    exports.rNotify:ShowBasicTopNotification(tostring(text), tonumber(duration))
end)

RegisterNetEvent('rNotify:ShowSimpleCenterText')
AddEventHandler('rNotify:ShowSimpleCenterText', function(text, duration)
    exports.rNotify:ShowSimpleCenterText(tostring(text), tonumber(duration))
end)
